...
## 110. На странице https://hazadus.ru/blog/asyncio-fowler

- ⌨️ Текст ссылки: "приведён пример"
- ⛓️‍💥 Внешний URL: https://github.com/hazadus/asyncio-learn/blob/main/inside-cpython/subinterpreters_portscanner.py
- ⚠️ Ошибка: GET "https://github.com/hazadus/asyncio-learn/blob/main/inside-cpython/subinterpreters_portscanner.py" → status code = 429

## 111. На странице https://hazadus.ru/blog/redis-nuxt-view-counter
...
## 114. На странице https://hazadus.ru/blog/nuxt-content-render-md-component

- ⌨️ Текст ссылки: "пример использования"
- ⛓️‍💥 Внешний URL: https://github.com/hazadus/drf-nuxt-library/blob/main/frontend/components/MarkdownStringRenderer.vue
- ⚠️ Ошибка: GET "https://github.com/hazadus/drf-nuxt-library/blob/main/frontend/components/MarkdownStringRenderer.vue" → status code = 429
